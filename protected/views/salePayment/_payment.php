...
<div id="payment_container">
                        ...
                        <div class="col-sm-9">
                             <span class="input-icon">
                                <?php echo $form->textField($model, 'payment_amount', array(
                                    'class' => 'input-large text-center payment-amount-txt',
                                    'id' => 'payment_amount_id',
                                    'data-url' => Yii::app()->createUrl('wholeSale/AddPayment/'),
                                    'placeholder' => Yii::t('app',
                                            'Payment Amount') . ' ' . $selected_currency->currency_symbol,
                                ));
                                ?>
    ...
    <?php $this->widget('bootstrap.widgets.TbTabs', array(
        ...
        'tabs'=>array(
            array('label'=>Yii::t('app','Invoices'),'id'=>'tab_1', 'content'=>$this->renderPartial('_invoice', array('model'=>$model,'client_id'=>$client_id,'balance'=>$balance),true),'active'=>true),

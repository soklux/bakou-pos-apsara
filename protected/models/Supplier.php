...
class Supplier extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array(
                'id, company_name, first_name, last_name, mobile_no, address1, address2, city_id, country_code, email, notes, status, search',
                'safe',
                'on' => 'search'
            ),
        );
    ...
    public function suggest($keyword, $limit = 20)
    {
        ...
        foreach ($models as $model) {
            $suggest[] = array(
                'label' => $model->company_name . ' - ' . $model->mobile_no,
